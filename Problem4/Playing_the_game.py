...
We need to implement one final function to complete our word-game program. Write the code that implements the playGame function.
You should remove the code that is currently uncommented in the playGame body. Read through the specification and make sure you understand what this function accomplishes.
...
def playGame(wordList):
    ...
    while userInput != 'e':
        ...
        elif userInput == 'r' and playedHand == False:
            print "You have not played a hand yet. Please play a new hand first!"
        elif userInput == 'n':
            playedHand = True
            handed = dealHand(HAND_SIZE)
            playHand(handed, wordList, HAND_SIZE)
        elif userInput == 'r'and playedHand:
            playHand(handed, wordList, HAND_SIZE)
        elif userInput == 'e':
            break
